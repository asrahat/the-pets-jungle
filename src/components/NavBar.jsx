...
import { Menu, X, LayoutDashboard, LogOut, User, PawPrint } from "lucide-react";
  ...
  return (
    <nav
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${
        scrolled
          ? "bg-white/70 py-2 shadow-md backdrop-blur-xl"
          : "bg-transparent py-4"
      }`}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="group flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Adopt Your Best Friend</p>
          </div>
        </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/register">
                <Button
                  size="sm"
                  radius="full"
                  className="h-11 bg-green-600 px-6 font-bold text-white shadow-xl transition hover:scale-105"
                >
                  Register
                  <FaArrowRight />
                </Button>
            ...
            <div className="group relative">
              <button className="flex items-center gap-3 rounded-full border border-slate-200 bg-white p-1 pr-4 shadow-sm transition hover:shadow-md">
                ...
                <div className="hidden text-left lg:block">
                  ...
                  <p className="text-xs text-slate-500">Pet Lover</p>
                </div>
              </button>
              ...
              <div className="absolute right-0 top-14 hidden w-60 flex-col rounded-2xl border border-slate-100 bg-white p-2 shadow-2xl group-hover:flex">
                ...
                <button
                  ...
                  className="flex items-center gap-3 rounded-xl px-4 py-3 text-left text-sm text-red-500 transition hover:bg-red-50"
                >
                  <LogOut size={18} />
                  Logout
                </button>
      ...
      <div
        className={`fixed right-0 top-0 z-50 h-screen w-[300px] bg-white shadow-2xl transition-transform duration-300 md:hidden ${
      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-5 py-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold">The Pets Jungle</h2>
          </div>
